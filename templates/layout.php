            ...
            <section class="content__side">
                ...
                <nav class="main-navigation">
                    ...
                    <?php foreach ($projects as $key => $val): ?>
                        <li class="main-navigation__list-item <?=(isset($project_id) && $project_id === intval($val["project_id"])) ? "main-navigation__list-item--active" : ""; ?>">
                            <a class="main-navigation__list-item-link" href=<?="index.php?project_id=" . $val["project_id"]; ?>><?=strip_tags($val["project_name"]); ?></a>
